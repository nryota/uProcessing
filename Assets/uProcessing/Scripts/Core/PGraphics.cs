...
namespace uP5
{
    ...
    public class PGraphics : MonoBehaviour
    {
        ...
        [SerializeField]
        private BasicPrefabs basicPrefabs = new BasicPrefabs();
        #endregion
...
#pragma warning restore 108
        ...
        */
        ...
        {
            system.work.Translate(toSceneCoordinate(pos));
        }
        ...
        public PImage createImage(float width, float height, TextureFormat texFormat = TextureFormat.ARGB32)
        {
            return createImage((int)width, (int)height, texFormat);
        }
        public PImage createImage(int width, int height, TextureFormat texFormat = TextureFormat.ARGB32)
        {
            return createImage(system.work.gameObject, width, height, texFormat);
        }

        public PImage createImage(GameObject obj, int width, int height, TextureFormat texFormat = TextureFormat.ARGB32)
        {
	...
	public Vector2 touch(int index) {
        ...
        public void background(Color c) { background((int)(c.r * 255), (int)(c.g * 255), (int)(c.b * 255), (int)(c.a * 255)); }
